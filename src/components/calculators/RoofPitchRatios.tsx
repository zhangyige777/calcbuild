...
export default function RoofPitchRatios() {
  ...
  const results: CalcResultItem[] = useMemo(() => {
    ...
    const items: CalcResultItem[] = [
      ...
      { label: 'Multiplier', value: `×${factor.toFixed(3)}`, unit: '' },
    ];
  ...
  return (
    <div className="space-y-6">
      ...
      {/* Pitch Factor Chart */}
      <div>
        <h2 className="text-[2.2rem] font-bold text-[#444] dark:text-[#F5F5F5] mb-[15px]">Common Roof Pitch Ratios</h2>
