...
export default function TopsoilCalculator() {
  ...
  const results: CalcResultItem[] = useMemo(() => {
    ...
    const density = 1.0; // tons per cubic yard for topsoil
    ...
    const bags = Math.ceil(weightLbs / 40);
    const costEstimate = cubicYards * 20; // average $20 per cubic yard
    ...
    return [
      ...
      { label: '40lb Bags', value: bags.toString(), unit: 'bags' },
